            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="#features">行业动态</a></li>
                        <li class="scroll"><a href="#services">驾校开通申请</a></li>
                        <li class="scroll"><a href="#portfolio">学员报名</a></li>
                        <li class="scroll"><a href="#about">课程介绍</a></li>
                        <li class="scroll"><a href="#meet-team">驾校查询</a></li>
                        <li class="scroll"><a href="#pricing">通知公告</a></li>
                        <li class="scroll"><a href="#blog">用户登录</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2>在线学<span>在线考</span> </h2>
                                <!--     <p>学员在任何时候，只需登陆网站，就可以在网站学习到完整的驾驶员理论知识</p> -->
                ...
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2>计时培训<span>全信息化</span>驾校管理</h2>
                                  <!--   <p>实现管理部门对驾校、教练和学员情况统一汇总管理，一目了然。</p> -->
                                    <a class="btn btn-primary btn-lg" href="#">Read More</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-9">
                    <h2>系统简介</h2>
                    <p>
                    机动车驾驶员计时培训系统以计算机系统及通信信息技术为基础，为提高机动车驾驶员培训质量，满足机动车驾驶员培训机构对学员进行计时计程培训的要求，实现培训记录的电子化，满足道
路运输管理机构对学员培训过程进行监管，同时可以面向其他相关机构提供信息服务的系统平台。
                    </p>
                </div>
                <div class="col-sm-3 text-right">
                    <a class="btn btn-primary btn-lg" href="#">Join Us Now!</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="features">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">行业动态</h2>
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInLeft">
                    ...
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe src="1.mp4" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                    </div>
                </div>
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2019 chuanyi. Designed by JX1809 <a target="_blank" href="http://shapebootstrap.net/" title="Free Twitter Bootstrap WordPress Themes and HTML templates">ShapeBootstrap</a>
                </div>
                <div class="col-sm-6">
                    <ul class="social-icons">
                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
...
<!--     <script src="http://maps.google.com/maps/api/js?sensor=true"></script> -->
	...
	<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=2nU2YaBRHY9uyvC7TvQqnOw3jFdRohTg"></script>
